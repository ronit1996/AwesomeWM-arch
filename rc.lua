...
beautiful.init("/home/ronit/.config/awesome/themes/theme.lua")
...
gears.timer {
    ...
    autostart = true,
    callback = function ()
        awful.spawn.easy_async("/home/ronit/.config/awesome/scripts/wifi.sh", function (stdout)
    local wifi = stdout
...
local volume_bar = wibox.widget{
    ...
    forced_width = 100,
    border_width = 0,
    background_color = beautiful.catppuccin_base,
    color = beautiful.catppuccin_peach,
...
--| CREATE A CUSTOM BLUETOOTH WIDGET |--
...
gears.timer {
    ...
    autostart = true,
    callback = function ()
        awful.spawn.easy_async("/home/ronit/.config/awesome/scripts/bt_device_name.sh", function (stdout)
	local bt = stdout
	update_bt_name(bt)
    end)
end
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "  ", "  ", "  ", " 󰙯 ", " 󰓓 ", "  ", " 󰍫 ", "  ", "  " }, s, awful.layout.layouts[1])
...
-- PULSE AUDIO volume control
   awful.key({}, "XF86AudioRaiseVolume",
      function()
         awful.spawn("/home/ronit/.config/awesome/scripts/volume_up.sh")
      end,
   ...
   awful.key({}, "XF86AudioLowerVolume",
      function()
         awful.spawn("/home/ronit/.config/awesome/scripts/volume_down.sh")
      end,
...
-- BLUETOOTH CONNECT AND DISCONNECT --
    awful.key({ modkey,           }, "b", function () awful.spawn("/home/ronit/.config/awesome/scripts/bluetooth_connect.sh") end,
    	     {description = "Bluetooth toggle switch", group = "hotkeys"}),

-- SCREENSHOT SHORT CUT --
    awful.key({},"Print", function () awful.spawn("/home/ronit/.config/awesome/scripts/screenshot.sh") end,
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn("rofi -show drun -icon-theme 'ePapirus' -show-icons") end,
